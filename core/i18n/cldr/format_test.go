...
var renderCases = []renderCase{
	...
	{"zh-CN", cldr.FormatZhCN, "1,234,567.89", "$1,234.56", "50%", "2006/01/02", "15:04", "2006/01/02 15:04"},
	{"ko-KR", cldr.FormatKoKR, "1,234,567.89", "$1,234.56", "50%", "2006. 01. 02.", "PM 3:04", "2006. 01. 02. PM 3:04"},
}
