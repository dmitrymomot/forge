...
// Errors become Issues via captureHandler/sentry.CaptureException, not via sentryslog.
...
// Issues via CaptureException. Confirmed against sentry-go v0.48.0. The thin glue here
...
func realSentryHandler(cfg Config) (slog.Handler, error) {
	// v0.48.0: ClientOptions has no EnableLogs; logs are on by default, gated by
