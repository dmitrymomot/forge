...
func NotInList[T comparable](field string, value T, forbiddenValues []T) Rule {
	return Rule{
		Check: func() bool {
			return !slices.Contains(forbiddenValues, value)
		},
		Error: ValidationError{
			Field:          field,
...
func ValidStatus(field, value string, allowedStatuses []string) Rule {
	return Rule{
		Check: func() bool {
			return slices.Contains(allowedStatuses, value)
		},
		Error: ValidationError{
			Field:          field,
...
func ValidPermission(field, value string, allowedPermissions []string) Rule {
	return Rule{
		Check: func() bool {
			return slices.Contains(allowedPermissions, value)
		},
		Error: ValidationError{
			Field:          field,
...
func ValidCategory(field, value string, allowedCategories []string) Rule {
	return Rule{
		Check: func() bool {
			return slices.Contains(allowedCategories, value)
		},
		Error: ValidationError{
			Field:          field,
